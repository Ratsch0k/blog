...
_Broker_ is an easy and retired Hack The Box machine.
...
_I failed to create a screenshot of the admin panel when I was working on this machine. I yoinked the screenshot from [0xdf's](https://0xdf.gitlab.io/) [write-up](https://0xdf.gitlab.io/2023/11/09/htb-broker.html#)._
...
_Had to experiment a little bit with esaping characters such as `>`._
...
_After completing the challenge I looked at other write-ups to see if they did anything different. I saw that we could actually exploit this to gain full root access. I won't explain it here but if you're interested I can highly recommend looking at the official write-up._
